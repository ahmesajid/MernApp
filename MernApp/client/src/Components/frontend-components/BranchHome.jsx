      ...
      .then((data) => {
        ...
        if (this.state.thisBranchData[0].fNames.length) {
          while (i < this.state.thisBranchData[0].fNames.length) {
            tempArr.push({
              fName: this.state.thisBranchData[0].fNames[i],
              id: `${i}`,
            });
            ++i;
          }
                ...
                <div className="mt-4">
                  ...
                  >
                    ...
                    <div className="pl-3 pr-3 pt-3 row ">
                      ...
                      <div className="col-8">
                        {this.state.thisBranchData[0].contact}
                      </div>
                    </div>
                    <div className="p-3 row d-flex justify-content-center">
                      ...
                      <div className="col-8">
                        {this.state.thisBranchData[0].gmail}
                      </div>
                    </div>
                    {/*Map Function (End)*/}
                  </div>
              ...
              <div class="modal-body">
                ...
                <form onSubmit={(e) => this.reserveTable(e)}>
                  ...
                  <input
                    type="number"
                    class="form-control m-2 p-2"
                    placeholder="Reserve for how many persons"
                    required
